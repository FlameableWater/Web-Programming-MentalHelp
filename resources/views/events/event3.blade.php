    ...
    @section('content')
        ...
        <div class="jumbotron position-relative">
            ...
            <div class="container position-relative mt-5">
                ...
                <img src="{{ asset('images/event3.jpg') }}" class="img-fluid mt-4 d-block mx-auto border border-danger" style="width: 500px; height: 350px;" alt="Example Image">
                <p class="d-block mx-auto text-light text-center mt-3 fs-4">Event Date : 6 January 2023</p>
